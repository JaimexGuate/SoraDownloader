...
function App() {
  ...
  const ErrorMessage = ({ message }) => (
    <div className="mt-8 p-4 bg-red-900/40 border border-red-700 rounded-xl flex items-start space-x-3 shadow-lg">
        ...
        <div className="w-full max-w-3xl flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            ...
            <div className="flex-grow flex items-center bg-gray-800 border border-gray-700 rounded-xl shadow-xl p-1.5 max-w-2xl mx-auto">
                <input
                    type="url"
                    placeholder="Pega el enlace del video (YouTube, TikTok, etc.)"
                    value={url}
          ...
          {(videoInfo || error) && (
            <div className="mt-4">
              <button
                onClick={handleReset}
                className="flex items-center text-xs px-3 py-1.5 bg-gray-800 hover:bg-gray-700 text-gray-400 rounded-lg transition duration-150 border border-gray-700"
              >
